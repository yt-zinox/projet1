         ...
         <div id="all" align="center">
            <nav>
               <ul>
                  ...
                  <li><a href="" name="chat1" style="text-decoration:none"><font color="#4B899B">Chat Publique</font></a></li>
                  <li><a href="chat_admin.php" name="chat2" style="text-decoration:none">Chat Admin</a></li>
